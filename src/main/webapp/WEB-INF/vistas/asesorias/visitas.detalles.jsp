                        ...
                        <div class="col-2 text-right">
                            <div class="dropdown dropleft">
                                ...
                                <div class="dropdown-menu" aria-labelledby="acciones">
                                    <a class="dropdown-item" href="<core:url value="/asesorias/${visita.getAsesoria().getId()}/visitas/${visita.getId()}/editar" />">
                    ...
                    <div class="table-responsive mt-4">
                        <table class="table table-striped">
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row" class="text-nowrap"><spring:message code="form.label.reason" /></th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                    <core:choose>
                                        <core:when test="${visita.getEstado() == 1}"><spring:message code="form.label.status.pendiente" /></core:when>
                                        <core:when test="${visita.getEstado() == 1}"><spring:message code="form.label.status.en_proceso" /></core:when>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <spring:message code="confirmation.delete.content" arguments="${visita.getId()}" />
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="<core:url value="/asesorias/${visita.getAsesoria().getId()}/visitas/${visita.getId()}/eliminar" />" method="post">
                            <sec:csrfInput />
